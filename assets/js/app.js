...
const NIFTY_100_STOCKS = [
    'TCS', 'INFY', 'HINDUNILVR', 'WIPRO', 'HCLTECH', 'TECHM', 'LT', 'MARUTI', 'M&M', 'ASIANPAINT', 'BAJAJ-AUTO', 'NESTLEIND',
    ...
    'PIDILITIND', 'COLPAL', 'MARICO', 'SUNPHARMA', 'DRREDDY', 'DIVISLAB', 'PHARMEASY', 'IPCALAB',
    'BAJAJFINSV', 'SBILIFE', 'HDFCLIFE', 'ICICIPRULI', 'INDUSINDBK', 'TITAN', 'ULTRACEMCO', 'GRASIM', 'AIRTELLORIG',
...
const MARKET_CAP_ORDER = [
    'RELIANCE', 'TCS', 'HDFCBANK', 'ICICIBANK', 'BEL', 'INFY', 'HINDUNILVR', 'KOTAKBANK', 'ITC', 'BHARTIARTL',
    'SBIN', 'AXISBANK', 'LT', 'MARUTI', 'ASIANPAINT', 'NESTLEIND', 'HDFCLIFE', 'SBILIFE', 'LIC', 'TITAN',
    'ULTRACEMCO', 'BAJAJFINSV', 'EICHER', 'BRITANNIA', 'APOLLOHOSP', 'SUNPHARMA', 'DRREDDY', 'DIVISLAB',
