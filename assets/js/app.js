...
const NIFTY_100_STOCKS = [
    ...
    'RELIANCE', 'JSWSTEEL', 'TATASTEEL', 'HINDALCO', 'VEDL', 'SHRIRAMFIN', 'BEL', 'LIC',
    ...
    'SIEMENS', 'ABB', 'VOLTAS', 'WHIRLPOOL', 'HAVELLS', 'SYMPHONY', 'BOMDYEING', 'KALYANNVRTH','HAL', 'INDIAVIX'
];

const MARKET_CAP_ORDER = [
    'RELIANCE', 'TCS', 'HDFCBANK', 'ICICIBANK', 'BEL', 'INFY', 'KOTAKBANK', 'ITC', 'BHARTIARTL',
